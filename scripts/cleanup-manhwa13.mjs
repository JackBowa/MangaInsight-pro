...
const REMOVE_SECOND = [
  "return-of-the-blossoming-blade", // doublon — déjà en catalogue
  "heavenly-demon-reborn",           // doublon — déjà en catalogue
  "return-of-the-mad-demon",         // doublon — déjà ajouté en batch manhwa9
];

// Supprimer les bad matches et séries hors-scope
const REMOVE_FIRST = [
  "the-devil-butler", // manhua CN (Magic Emperor) — hors-scope
];
