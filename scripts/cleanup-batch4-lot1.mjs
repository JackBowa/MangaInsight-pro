...
const REMOVE = [
  ...
  "happy-no-return",  // bad match pour Cross Game
  "ao-haru-ride",     // bad match pour Strobe Edge (+ doublon avec blue-spring-ride)
  "if-you-love-me",   // bad match pour Say I Love You
];
