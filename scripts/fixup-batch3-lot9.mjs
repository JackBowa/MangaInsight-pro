...
// Step 1: Remove duplicate stub entries (second occurrences for these slugs)
const REMOVE_DUPES = [
  "toradora", "boys-over-flowers", "absolute-boyfriend",
  "skip-beat", "clannad", "golden-time"
];

// Step 2: Re-patch lot9 entries with correct type formats
// - tags: "A · B · C" (string, not array)
// - shops: [{ name, url, logo }] (array, not object)
const PATCHES = [
  {
    slug: "is",
    title: `I\\"s`,
    ...
    category: "shonen",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/i-s", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=I%22s+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=I%22s+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shonen",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/video-girl-ai", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=video+girl+ai+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=video+girl+ai+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shojo",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/marmalade-boy", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=marmalade+boy+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=marmalade+boy+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shojo",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/boys-over-flowers", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=hana+yori+dango+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=hana+yori+dango+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shojo",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/absolute-boyfriend", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=absolute+boyfriend+manga", logo: "/logos/fnac.svg" },
  ...
  },
  {
    ...
    category: "shojo",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/skip-beat", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=skip+beat+manga", logo: "/logos/fnac.svg" },
  ...
  },
  {
    ...
    category: "shojo",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/fruits-basket-another", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=fruits+basket+another+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=fruits+basket+another+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shonen",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/clannad", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=clannad+manga", logo: "/logos/fnac.svg" },
  ...
  },
  {
    ...
    category: "shonen",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/air", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=air+manga+key", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=air+manga+key", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shonen",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/little-busters", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=little+busters+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=little+busters+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shonen",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/toradora", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=toradora+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=toradora+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
  {
    ...
    category: "shonen",
    shops: [
      { name: "Manganim", url: "https://www.manganim.fr/manga/golden-time", logo: "/logos/manganim.svg" },
      { name: "Fnac", url: "https://www.fnac.com/SearchResult/ResultKNV.aspx?Search=golden+time+manga", logo: "/logos/fnac.svg" },
      { name: "Amazon", url: "https://www.amazon.fr/s?k=golden+time+manga", logo: "/logos/amazon.svg" }
    ],
    streaming: []
  },
];

// bracket-depth finder
function findEntry(content, slug, occurrence = 1) {
...
// Step 1: Remove second occurrences (stubs from batch3i import)
let removedDupes = 0;
for (const slug of REMOVE_DUPES) {
  const pos = findEntry(content, slug, 2);
  if (!pos) { console.log(`⚠️  No dupe for: ${slug}`); continue; }
  ...
  removedDupes++;
  console.log(`🗑️  dupe removed: ${slug}`);
}

// Step 2: Re-patch lot9 entries with correct format
let patched = 0;
for (const p of PATCHES) {
  const pos = findEntry(content, p.slug, 1);
  if (!pos) { console.log(`⚠️  Non trouvé : ${p.slug}`); continue; }
  const existingEntry = content.slice(pos.start, pos.end);
...
console.log(`\n🎉 Fixup lot9: ${removedDupes} dupes supprimés, ${patched}/${PATCHES.length} entrées corrigées.`);
