...
const REMOVE = [
  "shnd-ero-gal-iru-tte-hontou-desu-ka", // bad match pour Real (Takehiko Inoue)
  "chiisana-toiki",                        // bad match pour Kanon
  "angel-beats-track-zero",               // spinoff, pas le manga principal Angel Beats
  "plastic-memories-heartfelt-thanks",    // spinoff, pas le manga principal
  "slam-dunk",                             // doublon avec series-1
  "vagabond",                              // doublon avec series-1
  "ouran-high-school-host-club",           // doublon avec series-1
];
