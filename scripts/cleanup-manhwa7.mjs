...
const REMOVE = [
  "kage-aru-tokoro-ni",    // bad match pour Light and Shadow (manga JP)
  "megane-gakkou",         // bad match pour Let's Play (manga JP)
  "harley-takes-the-house", // bad match pour Beware of the Brothers (série différente)
];
